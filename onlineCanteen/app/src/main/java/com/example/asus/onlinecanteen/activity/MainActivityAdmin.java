...
public class MainActivityAdmin extends AppCompatActivity {
    ...
    String[] name = {"User Top Up","Confirm Top Up", "Store Withdrawal","Log Out"};

    String[] description = {"Untuk menambahkan saldo user","Melakukan konfirmasi Top Up request user", "Untuk membuat request store untuk menarik uang", "Log out sebagai admin"};

    String[] TAG = {"TOP_UP","C_TOP_UP","WITHDRAW", "LOGOUT"};
